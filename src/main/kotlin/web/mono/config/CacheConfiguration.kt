...
class CacheConfiguration(
    ...
    fun cacheManagerCustomizer(jcacheConfiguration: javax.cache.configuration.Configuration<Any, Any>): JCacheManagerCustomizer {
        return JCacheManagerCustomizer {
            createCache(it, web.mono.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration)
            createCache(it, web.mono.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration)
            createCache(it, web.mono.domain.User::class.java.name, jcacheConfiguration)
            createCache(it, web.mono.domain.Authority::class.java.name, jcacheConfiguration)
            createCache(it, web.mono.domain.User::class.java.name + ".authorities", jcacheConfiguration)
